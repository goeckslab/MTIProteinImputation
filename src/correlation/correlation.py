...
if __name__ == '__main__':
    ...
    if pre:
        imputed_data = pd.read_csv(f"results/imputed_data/ae/single/exp/{patient}/0/pre_treatment.csv")
    else:
        imputed_data = pd.read_csv(f"results/imputed_data/ae/single/exp/{patient}/0/on_treatment.csv")
    ...
    #sns.heatmap(cell_wise_correlations, cmap='coolwarm', annot=True)
    #plt.title('Heatmap of Cell-Wise Correlations')
    #plt.show()
