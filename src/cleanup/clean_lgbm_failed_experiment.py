...
SEARCH_PATHS = [
    Path("lgbm", "in_patient"),
    Path("lgbm", "in_patient_15_µm"),
    Path("lgbm", "in_patient_30_µm"),
    Path("lgbm", "in_patient_60_µm"),
    Path("lgbm", "in_patient_90_µm"),
    Path("lgbm", "in_patient_120_µm"),
    Path("lgbm", "exp_patient"),
    Path("lgbm", "exp_patient_15_µm"),
    Path("lgbm", "exp_patient_30_µm"),
    Path("lgbm", "exp_patient_60_µm"),
    Path("lgbm", "exp_patient_90_µm"),
    Path("lgbm", "exp_patient_120_µm"),
